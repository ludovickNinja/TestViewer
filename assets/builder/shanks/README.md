...
Place exported shank GLBs here. They will be served from `/assets/builder/shanks/<file>.glb`.
...
- Export from Rhino using the **shared jewelry coordinate system** (same world
  origin as the heads). The builder does **not** auto-center, auto-scale, or
...
Example file: `sample-solitaire-shank.glb`
